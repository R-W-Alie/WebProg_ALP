...
<head>
    <meta charset="UTF-8">
    <title>Your Cart - Sri'Cookies</title>
    <script src="https://cdn.tailwindcss.com"></script>
</head>
<body class="bg-gray-50">
    <nav class="bg-yellow-300 p-4 flex justify-between">
        <span class="font-bold text-lg">Sri'Cookies</span>
        <span>Hi, <?= htmlspecialchars($user_name) ?> | <a href="logout.php" class="text-red-600 font-semibold">Logout</a></span>
    </nav>
